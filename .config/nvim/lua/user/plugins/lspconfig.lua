return
{
    ...
    config = function()
        ...
        -- Called when server is attached to the buffer
        local on_attach = function(client, bufnr)
            ...
            vim.api.nvim_buf_set_keymap(bufnr, 'n', '<space>wr', '<cmd>lua vim.lsp.buf.reove_workspace_folder()<CR>', opts)
